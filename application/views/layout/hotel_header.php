...
<html>
	...
	<body>
		...
		<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
			...
			<ul class="nav menu">
				<li class="active"><a href="<?php echo base_url();?>Hotel"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
				
				<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
					<em class="fa fa-pencil-square-o">&nbsp;</em> Order <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><i class="fa fa-plus"></i></span>
					</a>
					<ul class="children collapse" id="sub-item-1">
						<li>
						
							<a class="" href="<?php echo base_url(); ?>Hotel/NewOrder"><em class="fa fa-file-o">&nbsp;</em>&nbsp;New Order</a>
					    </li>
						<li>
				
							<a class="" href="<?php echo base_url(); ?>Hotel/PlacedOrder"><em class="fa fa-file-o">&nbsp;</em>&nbsp;Placed Order</a>
					    </li>
					</ul>
				</li>
				<!-- <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
					...
					<ul class="children collapse" id="sub-item-2">
						<li>
							...
							<a class="" href="<?php echo base_url(); ?>Hotel"><em class="fa fa-file-o">&nbsp;</em>&nbsp;Add Laundry</a>
					    </li>
						<li>
							
							<a class="" href="<?php echo base_url(); ?>Hotel"><em class="fa fa-file-o">&nbsp;</em>&nbsp;View Laundry</a>
					    </li>
					</ul>
				</li> -->
				<li><a href="<?php echo base_url(); ?>Hotel"><em class="fa fa-pencil-square-o">&nbsp;</em>Track Request</a></li>
				<!-- <li><a href="<?php //echo base_url(); ?>Hotel/MyPayment"><em class="fa fa-pencil-square-o">&nbsp;</em>Payments</a></li> -->
